--[[
	...
	Aids by Exunys © CC0 1.0 Universal (2023)
...
local Aimbot, WallHack = getgenv().Aids.Aimbot, getgenv().Aids.WallHack
...
do
	...
	game.StarterGui:SetCore("SendNotification", {
		Title = "🎆  Aids V2  🎆",
		Text = "Would you like to use the new Aids V2 script?",
		Button1 = "Yes",
		Button2 = "No",
		Duration = 1 / 0,
